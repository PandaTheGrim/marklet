...
public final class MarkletOptions {
  ...
  /** Option name for override project readme file (`-o`) * */
  private static final String README_OVERRIDE_OPTION = "-o";
  ...
  static {
    ...
    OPTIONS_COUNT.put(README_OVERRIDE_OPTION, 2);
  ...
  /** Override project readme or use separate, stored with generated files. * */
  @Getter private final boolean overwriteProjectReadme;
  ...
  private MarkletOptions(final Map<String, String> options) {
    ...
    this.overwriteProjectReadme =
        parseBoolean(options.getOrDefault(README_OVERRIDE_OPTION, "false"));
